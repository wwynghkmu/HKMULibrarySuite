...
hk.edu.hkmu.lib.Config.init();
        ...
        String username = "";
        if(authen!=null && hk.edu.hkmu.lib.Config.VALUES.get("ALLOWUSERS").toLowerCase().contains(authen.getUserid().toLowerCase()) )
...
<font color=lightblue size=5> <b>  OUHK LIB TSServices Tools (Testing Site) - <%=username%></b> </font>
<ul>
<li>
<a href="index.jsp">Main Page</a>
</li>
<li>
<a href="systemLog.jsp"> System Log</a>
</li>
<li>
   <li class='has-sub'><a href='#'><span>Configuration</span></a>
      <ul>
         <li class='has-sub'><a href='config.jsp'><span>General Configuration</span></a></li>
         <li class='has-sub'><a href='staffLeaveConfig.jsp'><span>Staff Leave Configuration</span></a></li>
      </ul>
