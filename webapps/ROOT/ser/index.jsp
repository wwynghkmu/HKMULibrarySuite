...
<h1> OUHK LIB SER Admin System </h1>
<br>
<%
hk.edu.hkmu.lib.ser.Config.init();
	...
	if(!(username == null && password == null) && authen==null){
		...
		if(hk.edu.hkmu.lib.ser.Config.VALUES.get("ALLOWUSERS").toLowerCase().contains(authen.getUserid().toLowerCase()) && authen.isAuthenticated() ){
	...
	if(authen!=null && authen.isAuthenticated() && hk.edu.hkmu.lib.ser.Config.VALUES.get("ALLOWUSERS").toLowerCase().contains(authen.getUserid().toLowerCase()) ){
		response.sendRedirect("/ser/help.jsp");
