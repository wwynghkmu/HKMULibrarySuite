...
<%
	String filedir = request.getServletContext().getRealPath("/") + "ser/logs";
%>
<br>
<br>
<br>
<br>
<br>
<h3> <b> SER Module System Logs</b> </h3>
<%
	...
	out.println("<thead><tr><td> <b> System Logs of SER LIB Tools</b> </td> <td> <b> </b></td></tr></thead><tbody>");
