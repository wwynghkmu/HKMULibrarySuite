...
<%
	String filedir = request.getServletContext().getRealPath("/") + "cat/logs";
%>
<br>
<br>
<br>
<br>
<br>
<h3> <b> CAT Module System Logs</b> </h3>
<%
	...
	out.println("<thead><tr><td> <b> System Logs of CAT LIB Tools</b> </td> <td> <b> </b></td></tr></thead><tbody>");
