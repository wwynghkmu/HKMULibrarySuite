...
<br>
<br>
<h3> <b> TSServices Tools General Configuration </b> </h3>
<%
hk.edu.hkmu.lib.Config.init();
	...
	String tol = request.getParameter("tol");
        ...
        String webinfdir = request.getServletContext().getRealPath("/") + "/WEB-INF/classes/hk/edu/ouhk/lib/";
        String configFilePath = basedir + "conf/config.txt";
        String configWebFilePath = webinfdir + "  + " + "config.txt";
	String logFilePath = basedir + "logs/" + hk.edu.hkmu.lib.Config.VALUES.get("FILEPROTECTIONKEY") + "-configLog.txt";
	if(cmd!=null){
