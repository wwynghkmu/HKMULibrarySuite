...
public class TestPrimoVESearchByNonISBN {
	public static void main(String[] args) {

		
		String inst = "OUHK";
		String author = "香港日本人俱樂部";
		String title = "香港日本人俱樂部會員名簿";
		String publisher = "日本人俱樂部";
		String year = "";
		String edition = "";
		String vol = "";
		...
		if (args.length != 0)
			inst = args[0];
		try {
			PrimoVEQueryByNonISBN q = new PrimoVEQueryByNonISBN(author, title, publisher, year, edition, vol, inst);
