 ...
 */
public class AlmaCreateCourseViaAPI {
	...
	public String CreateCourse(String code, String name, String instructor, String school, String sd, String ed,
		...
		try {
			...
			// parameter "term" accepts course terms in form of [term1],[term2],... the
			// following split the term string into a JSON strings readable by Alma.
			term = term.trim();
			...
			if (!code.equals(name))
				...
				data += "],\"status\":\"INACTIVE\",\"start_date\":\"" + sd + "\",\"end_date\":\"" + ed
				+ "\",\"weekly_hours\":\"0\",\"participants\":\"0\",\"year\":\"" + year
				+ "\",\"instructor\":[{\"primary_id\":\"" + instructor
				+ "\"}],\"campus\":[{\"campus_code\":{\"value\":\"code\"},\"campus_participants\":\"0\"}],\"submit_by_date\":\""
				+ sd + "\"}";
