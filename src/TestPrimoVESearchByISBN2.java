...
public class TestPrimoVESearchByISBN2{
	public static void main(String[] args){

		//Working API URL: https://api-ap.hosted.exlibrisgroup.com/primo/v1/search?vid=852HKMU_INST:hkmu&tab=LibraryCatalog&scope=MyInstitution&q=isbn,contains,9789622095465&apikey=l8xxeb2a38bf0cb840e59f4ecf7a8f1c01f0
		
		String inst = "OUHK";
		String isbn = "1403911959";
		//String isbn = "781058703X";
		String vol = "1";

		PrimoVEQueryByISBN q = new PrimoVEQueryByISBN(isbn, inst, vol);
		if(q.match()){
